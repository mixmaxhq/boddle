...
// **Models** are the basic data object in the framework -- frequently
...
// and transformations on that data.
...
export const Model = /*#__PURE__*/ (() => {
  ...
  const Model = class Model {
    ...
    // Proxy `sync` by default -- but override this if you need custom syncing
    // semantics for *this* particular model.
    sync(...args) {
  ...
  // The default name for the JSON `id` attribute is `"id"`. MongoDB and CouchDB
  // users may want to set this to `"_id"`.
  proto.idAttribute = 'id';

  // The prefix is used to create the client id which is used to identify models
  ...
  // Lodash methods that we want to implement on the Model, mapped to the number
